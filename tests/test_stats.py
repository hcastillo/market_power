...
class TestLog(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.statistics = Stats(self.model)
    ...
    def test_values(self):
        ...
        self.assertEqual(len(self.statistics.stats_items), 5)
        # check that the classes are in the correct order and the data stored with the correct names
        self.assertIsInstance(self.statistics.stats_items['firms_A'], StatsFirms)
        self.assertIsInstance(self.statistics.stats_items['bank_L'], StatsBankSector)
